...
public class MemcachedClientsLoadTest {
    ...
    public void testBigRoundtrip() throws Exception {
        ...
        for (final ClientSetup value : clientSetups) {
            for (int i = 0; i < params.length; ) {
                testRoundtrip(value, params[i++], params[i++], params[i++]);
            }
        }
    }

    private void testRoundtrip(final ClientSetup setup, final int docSize, final int threadCount, final int sessionLoopCount) throws Exception {
